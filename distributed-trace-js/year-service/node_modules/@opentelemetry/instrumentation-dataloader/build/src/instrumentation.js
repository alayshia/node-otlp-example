...
class DataloaderInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    init() {
        return [
            new instrumentation_1.InstrumentationNodeModuleDefinition(MODULE_NAME, ['^2.0.0'], (dataloader, moduleVersion) => {
                ...
                if (instrumentation_1.isWrapped(dataloader.prototype.load)) {
                    this._unwrap(dataloader.prototype, 'load');
                }
                if (instrumentation_1.isWrapped(dataloader.prototype.loadMany)) {
    ...
    _getPatchedConstructor(constructor) {
        ...
        function PatchedDataloader(...args) {
            ...
            if (instrumentation_1.isWrapped(inst._batchLoadFn)) {
    ...
    _patchLoad(proto) {
        if (instrumentation_1.isWrapped(proto.load)) {
    ...
    _patchLoadMany(proto) {
        if (instrumentation_1.isWrapped(proto.loadMany)) {
